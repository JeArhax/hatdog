...
def main_menu():
    while True:
        ...
        screen.fill((0, 0, 0))
        newbackground = pygame.transform.scale(background, (x,y))
        screen.blit(newbackground, (0, 0))
        draw_text('Debulsang Halimaw', font, (0,0,0), screen, 250, 40)
...
def game():
    ...
    while running:
        ...
        charmander = Pokemon('Charmander', level, 300, 150)
        squirtle = Pokemon('Squirtle', level, 550, 150)
